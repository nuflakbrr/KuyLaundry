...
export default function Footer() {
    ...
    const contactLink = [
        ...
        { href: 'https://linkedin.com/public-profile/in/nuflakbrr', name: 'LinkedIn' }
    ]
                ...
                <div className='flex flex-wrap'>
                    ...
                    <div className='w-full px-4 mb-12 md:w-1/5'>
                        <div className='flex'>
                            ...
                            {/* LinkedIn */}
                            <a href='https://linkedin.com/public-profile/in/nuflakbrr' target='_blank'>
                                <span className='mr-3 flex h-9 w-9 items-center justify-center rounded-full bg-gray-800 text-slate-100 hover:bg-sky-500 hover:text-zinc-50'>
                                    <svg
                                        role='img'
                                        width={20}
                            ...
                            {/* Email */}
                            <a href='mailto:naufalakbar378@gmail.com' target='_blank'>
                                <span className='mr-3 flex h-9 w-9 items-center justify-center rounded-full bg-gray-800 text-slate-100 hover:bg-sky-500 hover:text-zinc-50'>
                                    <svg
                                        role='img'
                                        width={20}
