                            ...
                            <div className='flex items-center justify-between pb-6'>
                                ...
                                <div className='flex flex-wrap items-center justify-between'>
                                    <div className='lg:ml-40 ml-10 space-x-8'>
                                        <Link to='/admin/transaction/add' className='flex items-center justify-center bg-sky-500 hover:bg-sky-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer'><FaCartPlus className='mr-2' /> Tambah Transaksi</Link>
                                    </div>
                                </div>
                            </div>
                            <div>
