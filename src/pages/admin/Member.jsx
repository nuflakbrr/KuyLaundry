                    ...
                    <div className=' flex items-center justify-between pb-6'>
                        ...
                        <div className='flex flex-wrap items-center justify-between'>
                            ...
                            <div className='lg:ml-40 ml-10 space-x-8'>
                                <Link to='/admin/member/add' className='flex items-center justify-center bg-sky-500 hover:bg-sky-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer'><FaUserPlus className='mr-2' /> Tambah Member</Link>
                            </div>
                        </div>
                    </div>
                    <div>
