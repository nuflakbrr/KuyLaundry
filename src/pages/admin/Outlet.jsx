                    ...
                    <div className='flex flex-wrap items-center justify-between pb-6'>
                        ...
                        <div className='flex flex-wrap items-center justify-between lg:mt-0 mt-5'>
                            ...
                            <div className='lg:ml-20 ml-10 space-x-8'>
                                <Link to='/admin/outlet/add' className='flex items-center justify-center bg-sky-500 hover:bg-sky-600 px-4 py-2 rounded-md text-white font-semibold tracking-wide cursor-pointer'><FaFolderPlus className='mr-2' /> Tambah Outlet</Link>
                            </div>
                        </div>
                    </div>
                    <div>
